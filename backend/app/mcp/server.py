...
def build_default_server():
    ...
    chat_scenario_tools.py, chat_base_value_tools.py,
    chat_eventuality_tools.py, and chat_rewrite_tools.py.
    ...
    from ..services import chat_rewrite_tools  # noqa: F401 -- registers onto mcp_registry
